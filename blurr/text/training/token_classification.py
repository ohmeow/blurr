# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../nbs/10_12_text-training-token-classification.ipynb.

# %% ../../../nbs/10_12_text-training-token-classification.ipynb 3
...
from ..data.core import first_blurr_tfm, get_blurr_tfm, TextDataLoader
...
from ...utils import clean_memory, get_hf_objects, PreCalculatedCrossEntropyLoss

# %% auto 0
__all__ = ['logger', 'calculate_token_class_metrics', 'TokenClassMetricsCallback', 'show_results']

# %% ../../../nbs/10_12_text-training-token-classification.ipynb 5
...
# %% ../../../nbs/10_12_text-training-token-classification.ipynb 55
...
# %% ../../../nbs/10_12_text-training-token-classification.ipynb 58
...
# %% ../../../nbs/10_12_text-training-token-classification.ipynb 60
@typedispatch
def show_results(
