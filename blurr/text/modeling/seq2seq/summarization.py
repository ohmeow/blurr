# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../nbs/21_text-modeling-seq2seq-summarization.ipynb.

# %% auto 0
__all__ = ['BlearnerForSummarization']

# %% ../../../../nbs/21_text-modeling-seq2seq-summarization.ipynb 5
...
# %% ../../../../nbs/21_text-modeling-seq2seq-summarization.ipynb 7
# silence all the HF warnings
warnings.simplefilter("ignore")
hf_logging.set_verbosity_error()

# %% ../../../../nbs/21_text-modeling-seq2seq-summarization.ipynb 36
@patch
def blurr_summarize(self: Learner, inp, **kwargs):
    preds = self.blurr_generate(inp, key="summary_texts", **kwargs)
    return preds

# %% ../../../../nbs/21_text-modeling-seq2seq-summarization.ipynb 45
