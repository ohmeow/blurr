...
# %% auto 0
__all__ = ['Singleton', 'str_to_type', 'print_versions', 'set_seed', 'PreCalculatedLoss', 'PreCalculatedCrossEntropyLoss',
           'PreCalculatedBCELoss', 'PreCalculatedMSELoss', 'MultiTargetLoss']
