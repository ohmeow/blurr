...
__all__ = ['str_to_class', 'Singleton', 'ModelHelper', 'BLURR_MODEL_HELPER', 'HF_ARCHITECTURES', 'HF_TASKS_ALL',
           'HF_TASKS_AUTO', 'MaskedLMTask', 'QuestionAnsweringTask', 'SequenceClassificationTask',
           'TokenClassificationTask', 'PreTrainingTask', 'LMHeadTask', 'ConditionalGenerationTask',
           'MultipleChoiceTask', 'NextSentencePredictionTask', 'QuestionAnsweringSimpleTask', 'LMHeadModelTask',
           'ClassificationTask']
...
# Cell
class MaskedLMTask: pass
class QuestionAnsweringTask: pass
class SequenceClassificationTask: pass
class TokenClassificationTask: pass
class PreTrainingTask: pass
class LMHeadTask: pass
class ConditionalGenerationTask: pass
class MultipleChoiceTask: pass
class NextSentencePredictionTask: pass
class QuestionAnsweringSimpleTask: pass
class LMHeadModelTask: pass
class ClassificationTask: pass